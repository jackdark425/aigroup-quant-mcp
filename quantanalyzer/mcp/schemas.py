...
""",
            ...
            "examples": [
                {
                    "name": "加载2023年股票数据",
                    "description": "加载完整年度数据用于模型训练",
                    "input": {
                        "file_path": "D:/data/stock_data_2023.csv",
                        "data_id": "stock_2023"
                    },
                    "expected_output": "数据成功加载，返回数据摘要（行数、列数、日期范围、股票数量等）"
                },
                {
                    "name": "加载训练集数据",
                    "description": "加载用于模型训练的历史数据",
                    "input": {
                        "file_path": "./data/training_set.csv",
                        "data_id": "training_data"
                    },
                    "expected_output": "训练数据加载完成，可进行因子生成"
                },
                {
                    "name": "加载回测数据",
                    "description": "加载用于策略回测的数据",
                    "input": {
                        "file_path": "/home/user/backtest/hs300_2020_2023.csv",
                        "data_id": "hs300_backtest"
                    },
                    "expected_output": "回测数据就绪，包含沪深300成分股2020-2023年数据"
                }
            ]
        }
    )
